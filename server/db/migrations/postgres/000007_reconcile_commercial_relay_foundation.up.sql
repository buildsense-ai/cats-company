-- Two independently developed migrations historically used version 000002:
-- commercial_relay_foundation and weixin_clawbot_tokens. Version 000006
-- preserves the later Weixin migration under a unique number. This migration
-- repairs databases whose recorded version 2 referred to the Weixin schema,
-- because those databases would otherwise skip the commercial schema.
