...
func (a *Adapter) CreateSchema() error {
	statements := []string{
		...
		createConversationTaskStatusSyncFunction,
		createConversationTaskStatusSyncTrigger,
...
const createConversationTaskStatusSyncFunction = `
...
const createConversationTaskStatusSyncTrigger = `
CREATE OR REPLACE TRIGGER trg_conversation_task_statuses_sync_source
