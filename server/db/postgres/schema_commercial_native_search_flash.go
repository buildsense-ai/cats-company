...
// pool: the six chat models split the same allowance the five used to hold.
...
-- Historical migration, now a no-op: DeepSeek Flash replaced DeepSeek V4 in the paid plans.
--
