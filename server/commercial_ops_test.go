...
func TestCommercialOpsWriteIsAuditedWithoutRequestBody(t *testing.T) {
	...
	handler.HandlePlans(rec, commercialOpsRequest(http.MethodPost, "/api/account/commercial-ops/plans", `{
		...
		"model_budgets":{"MiniMax-M2.7":2100,"MiniMax-M3":2100,"deepseek-v4-flash":2100,"glm-5.3-flash":2100,"gpt-5.6-terra":2100,"gpt-image-2":100,"gpt-image-2.5":100,"gpt-image-2.5-flare":100,"gpt-image-2.5-sunburst":100,"chatgpt-image-latest":100},
		"duration_days":30,
		"state":0
	}`))
	if rec.Code != http.StatusOK {
