...
func main() {
	...
	mux.HandleFunc("/api/agents/channels", jwtAuthWithDB(agentHandler.HandleAgentChannels))
	mux.HandleFunc("/api/agents/channels/weixin/qrcode", jwtAuthWithDB(agentHandler.HandleWeixinChannelQRCode))
	mux.HandleFunc("/api/agents/channels/weixin/qrcode-status", jwtAuthWithDB(agentHandler.HandleWeixinChannelQRCodeStatus))
