...
func main() {
	...
	botHandler.SetBotDefinitionStore(botDefinitionStore)
	botModelConfigHandler := server.NewBotModelConfigHandler(db, botModelStore)
	botModelConfigHandler.SetBotDefinitionStore(botDefinitionStore)
	botDefinitionHandler := server.NewBotDefinitionHandler(db, botDefinitionStore, botModelStore)
