...
describe('MessagesView composer draft isolation', () => {
  ...
  it('persists structured mentions and attachments as they change', async () => {
    const composerDraftStore = {
      inputDrafts: new Map(),
      structuredMentionDrafts: new Map(),
      attachmentDrafts: new Map(),
    ...
    expect(composerDraftStore.structuredMentionDrafts.get('grp_80')).toEqual([{
      target: 'usr42',
      label: 'Saturday',
      start: 0,
      end: 9,
    ...
    expect(composerDraftStore.attachmentDrafts.get('grp_80')).toEqual([attachment]);
    expect(composerDraftStore.persist).toHaveBeenCalled();
  });
