...
const teamMembers: TeamMember[] = [
  ...
  { name: '方块', role: '工程', position: '100% 0%', image: '/team-avatar-fangkuai.png', imageWidth: 1254, imageHeight: 1254, imageScale: 1.22, left: 59, top: 20, size: 90, mobileLeft: 17, mobileTop: 38, mobileSize: 66 },
