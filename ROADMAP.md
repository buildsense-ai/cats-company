...
- [x] HTTPS 强制 ✅
- [x] CORS 收紧 ✅
- [x] JWT 会话失效治理（删号/封号后立即失效，前端强制退出）✅
- [ ] 消息内容审核
- [ ] Redis Pub/Sub 多节点扩展
...
### 2026-08-24
- JWT 会话失效治理：禁用/删除账号后所有中间件查库校验并返回 403 ACCOUNT_DISABLED；在线 WebSocket 立即断开（close code 4403）；前端收到 4403 或 403 ACCOUNT_DISABLED 时清除登录态强制退出
